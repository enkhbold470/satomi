...
Step 1: Create a Google Cloud Storage bucket and set the appropriate permissions. You can follow the steps mentioned here up to step 5.
Step 2: Fork the example repository from github.com/mdmohsin7/omi-audio-streaming.
...
Developing Integration Apps for OMI


https://docs.omi.me/doc/developer/apps/AudioStreaming#real-time-audio-streaming